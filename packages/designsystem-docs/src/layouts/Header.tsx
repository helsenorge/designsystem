    ...
    <div className={props.className}>
        <HeaderContent>
            <Logo>
                ...
                <BannerText href="/"><span>helsenorge</span><span>design system</span></BannerText>
            </Logo>
            <Inner>
                <Search />
            </Inner>
            <HotLinks>
                <HotLink href="https://github.com/Helsenorge/designsystem-docs">
                    <img onMouseEnter={e => (e.currentTarget.src = gitHubHover)} onMouseLeave={e => (e.currentTarget.src = gitHub)} src={gitHub} />
                </HotLink>
                <HotLink href="https://github.com/Helsenorge/designsystem-docs">
                    <img onMouseEnter={e => (e.currentTarget.src = sketchHover)} onMouseLeave={e => (e.currentTarget.src = sketch)} src={sketch} />
                </HotLink>
                <HotLink href="https://helsedirutvikling.slack.com">
                    <img onMouseEnter={e => (e.currentTarget.src = slackHover)} onMouseLeave={e => (e.currentTarget.src = slack)} src={slack} />
                </HotLink>
            </HotLinks>
        </HeaderContent>
    </div>
