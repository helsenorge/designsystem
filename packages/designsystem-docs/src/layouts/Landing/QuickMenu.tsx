...
function StyledCard(props: CardProps) {
    ...
    return (
        <animated.div className={className} style={isHovered ? {...animatedProps, transform: 'translateY(-0.5rem)'} : animatedProps} onMouseEnter={() => setIsHovered(!isHovered)} onMouseLeave={() => setIsHovered(!isHovered)}>
            <CardLink to={to}>
                ...
                <Row style={{padding: '2rem 0 1rem 0'}} around="xs" center="xs">
                    <Col xs={12} sm={6} md={4}>
                        <Card to="/introduction" springProp={springProps.card(100)}>
                            ...
                            <CardDescription>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec ut orci quam.</CardDescription>
                        </Card>
                    </Col>
                    <Col xs={12} sm={6} md={4}>
