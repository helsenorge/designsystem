...
const Original = ({size = 300, color = 'wheelChair'}: {size?: number; color?: LogoColor}): JSX.Element => (
  <svg xmlns="http://www.w3.org/2000/svg" width={size} viewBox="0 0 502 220">
    <g fill={palette[color]}>
...
const Byline = ({size = 300, color = 'wheelChair'}: {size?: number; color?: LogoColor}): JSX.Element => (
  <svg xmlns="http://www.w3.org/2000/svg" width={size} viewBox="0 0 87 12">
    <g fill={palette[color]}>
