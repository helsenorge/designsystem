...
export type LinkType = React.ForwardRefExoticComponent<LinkProps & React.RefAttributes<unknown>>;
...
const Link: LinkType = React.forwardRef(
  (
    {children, className = '', color = 'neutral', icon, large = false, chevron = false, ...restProps}: LinkProps,
    ref: any,
  ) => {
