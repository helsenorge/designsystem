...
const componentUtils = globSync(`src/components/**/utils.{ts,tsx}`, { ignore: alwaysIgnore });
const hooksAndExtras = globSync(`src/**/*.{ts,tsx}`, { ignore: [...alwaysIgnore, 'src/components/**/*'] });

export const entries = [...components, ...componentUtils, ...hooksAndExtras].sort((a, b) => a.localeCompare(b)).reduce(createEntries, {});
