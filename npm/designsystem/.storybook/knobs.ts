...
export const allLinkListSizes: LinkListSize[] = ['small', 'medium', 'large'];

export const allTitleTags: TitleTags[] = ['h1', 'h2', 'h3', 'h4', 'h5', 'span'];

export const allLabelTags: LabelTags[] = ['h1', 'h2', 'h3', 'h4', 'h5', 'span', 'label', 'p'];

export const allTitleAppearances: TitleAppearances[] = ['titleFeature', 'title1', 'title2', 'title3', 'title4', 'title5'];
