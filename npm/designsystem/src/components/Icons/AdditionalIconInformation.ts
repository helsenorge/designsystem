export default {
  ...
  starstroke: { alternativeName: '', categories: 'System, Snarvei' },
  starfill: { alternativeName: '', categories: 'System, Snarvei' },
  measuringtape: { alternativeName: '', categories: 'Generisk' },
  thumbsup: { alternativeName: 'Tommel Opp', categories: 'Generisk' },
  thumbsdown: { alternativeName: 'Tommel Ned', categories: 'Generisk' },
  consentdocument: { alternativeName: '', categories: 'Generisk' },
  healthcarepersonnelsecurity: { alternativeName: '', categories: 'Generisk' },
  historydocument: { alternativeName: '', categories: 'Generisk' },
  personcommunication: { alternativeName: '', categories: 'Generisk' },
  persondocument: { alternativeName: '', categories: 'Generisk' },
  yesno: { alternativeName: '', categories: 'Generisk' },
};
