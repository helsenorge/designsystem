...
const Menu: React.FC<SvgPathProps> = ({ size, isHovered }: SvgPathProps): JSX.Element => {
  ...
  const small = <path d="M37.88 31.211v2.274H10.105v-2.274H37.88zm0-8.842v2.274H10.105v-2.274H37.88zm0-8.474v2.273H10.105v-2.273H37.88z" />;
