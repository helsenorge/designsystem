...
const meta = {
  ...
  argTypes: {
    variant: {
      control: 'select',
      options: Object.values(PanelOldVariant),
    },
    title: {
      control: 'text',
    },
    status: {
      control: 'select',
      options: Object.values(PanelOldStatus),
    },
    statusMessage: {
      control: 'text',
    },
...
export const AvatarAndDetails: Story = {
  render: () => (
    <PanelOld title={'Medisinsk fødselsregister (MFR)'} icon={<Avatar color="black">{'Line Danser'}</Avatar>}>
      <div>
...
export const AsButton: Story = {
  render: () => (
    <PanelOld
      title={'Medisinsk fødselsregister (MFR)'}
      icon={
        <Avatar color="black" variant="square">
          {'Line Danser'}
        </Avatar>
      }
