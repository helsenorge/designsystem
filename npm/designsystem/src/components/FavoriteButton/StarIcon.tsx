...
const normalStroke = 'var(--color-action-graphics-dark-normal)';
const normalFill = 'transparent';
const hoverFill = 'var(--color-action-graphics-dark-hover)';
const hoverStroke = 'var(--color-action-graphics-dark-hover)';
